  ...
  return (
    <>
                  ...
                  <Table.Row key={data.id}>
                    ...
                    <Table.Cell textAlign="center">
                      <Button
                        color="grey"
                        onClick={() => {
                          handleWithRedirect(`/users/${data.id}`);
                        }}
                      >
                        {" "}
                      ...
                      <Button
                        color="black"
                        onClick={() => {
                          handleWithRedirect(`/user/${data.id}/locations`);
                        }}
                      >
      ...
      >
        ...
        <Modal.Content>
          <Modal.Description>
            <h3> Deseja realmente Desativar Usuario?</h3>
          </Modal.Description>
        </Modal.Content>
        <Modal.Actions>
          <Button
            onClick={() => {
              handleWithDelete(userId);
              modalState(false);
            }}
          >
            Confirmar
          </Button>
          <Button color="black" onClick={() => modalState(false)}>
            Sair
          </Button>
        </Modal.Actions>
      </Modal>
